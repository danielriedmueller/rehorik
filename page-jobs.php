...
<div id="jobs">
    ...
    <div class="container">
        <div class="job-description">
            <h3>Zur Unterstützung unseres Teams, insbesondere in der Produktion, suchen wir ab sofort <br>- Eine/n</h3>
            <h2>Produktionshelfer/In-</h2>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li>Du bringst Teamfähigkeit, strukturierte und selbstständige Arbeitsweisen und ein hohes Maß an Eigeninitiative</li>
                </ul>
            </div>
            <div>
                ...
                <ul>
                    ...
                    <li>Zugang zu einem breitgefächerten Netzwerk aus Kaffee, Wein, Gastronomie und Event Branche</li>
