...
>
    ...
    <div class="rehorik-product-textarea-outer"><?php do_action('rehorik_product_processing'); ?></div>
    <div class="rehorik-product-textarea-outer"><div class="rehorik-product-preperation-recommendation"><?php do_action('rehorik_product_preperation_recommendation'); ?></div></div>
    <div class="rehorik-product-textarea-outer hellbraun"><?php do_action('rehorik_product_origin'); ?></div>
</div>
<div class="container">
