...
// Set the CSS classes.
$classes = [
    'rehorik-tribe-events-attendee-registration',
...
<div class="tribe-tickets__attendee-tickets">
	...
	>
		<?php foreach ( $tickets as $ticket ) : ?>
			...
			?>
			<div class="tribe-tickets__attendee-tickets-container rehorik-tribe-events-attendee-tickets-container" data-ticket-id="<?php echo esc_attr( $ticket->ID ); ?>">
