...
- Joure Fix
    - Regina
        ...
        - dev.rehorik zeigen
            ...
            - Produkte mit Text auf Startseite anstatt nur details
        - Probierpaket
...
- Worker die Abfragen abarbeiten
- welches Volumen ist vorhanden
- der Service Layer könnte auch auf einen eigenen Server ausgelagert werden
- MAG B1
- It Development
- wäre die teure all in one lösung
- Shopware Shop ist verbreiteter Woocommerce Konkurrent


- Julio: 2 Leute dachten dass man einen Termin braucht und dann kann man in der Straubinger alle Kaffees testen. Irgendwas auf der Webseite steht wohl
- 18.7 Influenceraktion
- viele Bestellungen werden erwartet
- Gutschein aktualisieren
- 24 Stunden Gültigkeit
- mit Julian nochmal genau ausmachen
- wieviel rabatt?
- von wiviel uhr bis wieviel uhr
- Keywords
- Julian priorisieren lassen
- Texter
- Längere Texte zu Lena
- Informationen liefern als grob geschriebener Text
- Corporate Language Guide
- Lena nutzt eigenes Jira
- Regina redet noch mit Eli
- Alexia ab August möglich
- 10.30 Geschenkkorbmeeting
...
- ist Experte für juristische und IT-spezifische Aspekte des Datenschutzes
- ist weisungsfrei und der Geschäftsführung unterstellt
- berät die Geschäftsführung zum Thema Datenschutz, schult die Mitarbeiterinnen und Mitarbeiter, kontrolliert die Einhaltung der Vorschriften, ist Vertrauensmann und neutraler Schlichter für alle Stellen, die potenziell Umgang mit personenbezogenen Daten haben.
...
- Vereinbarkeit der Aufgabe des Datenschutzbeauftragten mit dessen anderen haupt- und nebenamtlichen Aufgaben
...
- T-Shirts einpflegen
    - ???
- Maschinen
    - auf Fotos von Regina warten
- Keywords
    - auf Priorisierungen warten
- Frontpage neues Design
- VPN mit Klaus einrichten
- Geschenkkörbe
    - auf Definition warten
    - Mittwoch Geschenkkörbe fotografieren
- Dominik an Spirits Text erinnern
...
Cappuccino Tasse inkl. Untersetzter (13,95 Euro Brutto)
