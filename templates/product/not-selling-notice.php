...
<div class="not-selling-notice">
    ...
    <div id="resmio-rehorik-maschinenberatung"></div>
    <script>(function(d, s) {
            var js, rjs = d.getElementsByTagName(s)[0];
            js = d.createElement(s);
            js.src = "//static.resmio.com/static/de/widget.js#id=rehorik-maschinenberatung&color=%23393536&width=275&height=400&fontSize=14px&facebookLogin=false&backgroundColor=%23ffffff&commentsDisabled=false&newsletterSignup=false&linkBackgroundColor=%235c0d2f";
