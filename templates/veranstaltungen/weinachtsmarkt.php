...
<div id="special-category" class="weinachtsmarkt">
    ...
    <p><b>Was wirds geben?</b></p>
    <div class="golden-box">
        <ul>
            <li>ab 13 Uhr Baristakurse im 120°</li>
            <li>Glühwein- & Schaumweinbar mit Glühgin vom Malefiz</li>
            <li>Plattenverkauf von T-Recs</li>
            <li>Live Musik von Latinophonia</li>
            <li>Kunstaustellung von Katharieder Bauernhanddruck mit Live Siebdruckverfahren</li>
            <li>Kaffee Kurzfilme, präsentiert von der Kurzfilmwoche Regensburg im alten Käseladen</li>
            <li>Wein, Käse & Whiskey Tasting im Weinkeller</li>
            <li>ab 18 Uhr Showrösten mit Heiko Rehorik</li>
            <li>ab 22 Uhr Weihnachtsparty mit den DJs vom T-Recs</li>
        </ul>
    </div>
