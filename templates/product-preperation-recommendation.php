...
<div class="rehorik-recommendation">
    ...
    <?php else: ?>
        <?php if (!empty($textPieces[0]) || !empty($textPieces[1])): ?>
            ...
            <?php if (!empty($textPieces[0])): ?><div><strong>Typ:</strong> <span><?= $textPieces[0] ?></span></div><?php endif; ?>
            <?php if (!empty($textPieces[1])): ?><div><strong>Rezept:</strong> <span><?= $textPieces[1] ?></span></div><?php endif; ?>
        <?php endif; ?>
    <?php endif; ?>
</div>
