...
foreach (array_merge(INFORMATION_TAB_ATTRIBUTES, [BEAN_COMPOSITION_ATTRIBUTE_SLUG, STRENGTH_ATTRIBUTE_SLUG, FLAVOUR_VARIETY_ATTRIBUTE_SLUG, PRODUCT_OF_MONTH_ATTRIBUTE_SLUG]) as $attr) {
